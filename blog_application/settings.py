...
# SECRET_KEY = 'django-insecure-dmcub7tz8is-3*k*$-dd$bqm3trllv)wuj@6@zg5u%e6pg-z4-'
SECRET_KEY = os.environ.get('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = (os.environ.get('DJANGO_DEBUG_MODE') == "True")

ALLOWED_HOSTS = ['deverseblog.herokuapp.com']
...
DEFAULT_FROM_EMAIL = 'DeVerse Team <noreply@deverse.com>'
